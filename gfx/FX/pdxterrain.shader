# Real Snow Without Advanced Shaders - modified copy of
# game/gfx/FX/pdxterrain.shader from CK3 1.19.0.6 (Scribe).
#
# This file is Sharp Terrain Without Advanced Shaders plus one change: in the low
# spec pixel shader the snow is the same snow *material* the high spec path uses
# (ApplySnowMaterialTerrain: its own height blend, normal map, roughness and a frost
# layer), instead of the flat procedural ApplySnowDiffuse. The switch is
# TERRAINOPT_SNOW_MATERIAL in the PixelShader Code block. Everything below this
# paragraph is the original Sharp Terrain banner and applies unchanged.
#
# ---- original Sharp Terrain Without Advanced Shaders banner ----
...
PixelShader =
{
	...
	[[
		...
		//   The high spec snow material in the low spec pixel shader. Costs about
		//   4 ms of frame time at 5120x1440 in winter on an RTX 3050 Ti Laptop;
		//   comment it out for the flat procedural snow of Sharp Terrain.
